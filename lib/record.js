...
/**
 *  Record everything that's sent to the webserver
 */
const record = _.promise.make((self, done) => {
    ...
    self.app.use((request, response, next) => {
        self.simulator.requests.push({
            url: request.url,
            method: request.method,
            params: request.params, // this gets further modified
            query: request.query,
